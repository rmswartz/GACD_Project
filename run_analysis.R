...
names(clean.data) <- c("Subject", "Activity", "BodyAccMeanX1", "BodyAccMeanY1", 
                       "BodyAccMeanZ1", "BodyAccSDX1", "BodyAccSDY1", "BodyAccSDZ1", 
                       "GravityAccMeanX", "GravityAccMeanY", "GravityAccMeanZ", 
                       "GravityAccSDX", "GravityAccSDY", "GravityAccSDZ", 
                       "BodyAccJerkMeanX1", "BodyAccJerkMeanY1", "BodyAccJerkMeanZ1", 
                       "BodyAccJerkSDX1", "BodyAccJerkSDY1", "BodyAccJerkSDZ1", 
                       "BodyGyroMeanX1", "BodyGyroMeanY1", "BodyGyroMeanZ1", 
                       "BodyGyroSDX1", "BodyGyroSDY1", "BodyGyroSDZ1", 
                       "BodyGyroJerkMeanX", "BodyGyroJerkMeanY", "BodyGyroJerkMeanZ", 
                       "BodyGyroJerkSDX", "BodyGyroJerkSDY", "BodyGyroJerkSDZ", 
                       "BodyAccMagMean1", "BodyAccMagSD1", "GravityAccMagMean", 
                       "GravityAccMagSD", "BodyAccJerkMagMean", "BodyAccJerkMagSD", 
                       "BodyGyroMagMean", "BodyGyroMagSD", "BodyGyroJerkMagMean", 
                       "BodyGyroJerkMagSD", "BodyAccMeanX2", "BodyAccMeanY2", 
                       "BodyAccMeanZ2", "BodyAccSDX2", "BodyAccSDY2", "BodyAccSDZ2", 
                       "BodyAccJerkMeanX2", "BodyAccJerkMeanY2", "BodyAccJerkMeanZ2", 
                       "BodyAccJerkSDX2", "BodyAccJerkSDY2", "BodyAccJerkSDZ2", 
                       "BodyAccJerkMeanFreqX", "BodyAccJerkMeanFreqY", 
                       "BodyAccJerkMeanFreqZ", "BodyGyroMeanX2", "BodyGyroMeanY2", 
                       "BodyGyroMeanZ2", "BodyGyroSDX2", "BodyGyroSDY2", "BodyGyroSDZ2", 
                       "BodyGyroMeanFreqX", "BodyGyroMeanFreqY", "BodyGyroMeanFreqZ", 
                       "BodyAccMagMean2", "BodyAccMagSD2", "BodyBodyAccJerkMagMean", 
                       "BodyBodyAccJerkMagSD", "BodyBodyGyroMagMean", "BodyBodyGyroMagSD", 
                       "BodyBodyGyroJerkMagMean", "BodyBodyGyroJerkMagSD", 
